                        ...
                        <div class="panel-body">
                         <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <input type="text" name="position" placeholder="Work Position*">
                              </div>                             
                            </div>                           
                          </div>
                                <!-- Button -->
...
if (isset($_POST['login'])) {
    ...
    $sql = "SELECT * FROM admins where user_email = '$c_email' AND user_pass = '$c_pass'";
    $result = mysqli_query($conn, $sql);
    $rows = mysqli_fetch_array($result);

    if ($rows >=1) {
      $_SESSION['log']=true;
      $_SESSION['log_name'] = $rows['user_email'];
