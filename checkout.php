 ...
 <section id="checkout">
                      ...
                      <div class="panel-heading">
                        ...
                        <!-- first name --> 
                         <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-6" style="margin-left: 20%">
                             Address: xxxxx - Tetuan, Zamboanga City                           
                            </div>
                          </div> 
  ...
  ?>
                  ...
                  <div class="aa-payment-method">                    
                    ...
                    <label for="paypal"><input type="radio" name="optionsRadios" checked> Via GCash </label>
                    <img src="img/gcash.png" src="" border="0" alt="GCash Acceptance Mark" style="width: 40%;">    
