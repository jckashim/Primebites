        ...
        <div class="col-md-12">
          <div class="aa-header-bottom-area"> 
            ...
            <!-- / logo  --> 
             ...
             <!-- cart box -->
            <div class="aa-cartbox"> <a class="aa-cart-link" href="cart.php"> <span class="fa fa-shopping-basket"></span> <span class="aa-cart-title">SHOPPING CART</span> <span class="aa-cart-notify"><?php total_items(); ?></span> </a>
      ...
      <div class="navbar navbar-default" role="navigation">
        ...
        <div class="navbar-collapse collapse"> 
          ...
          <ul class="nav navbar-nav">
                ...
                <li><a href="order.php">MilkTeas</a></li>
                <li><a href="account.php">My Account</a></li>
                <li class="hidden-xs"><a href="cart.php">My Cart</a></li>
                <li class="hidden-xs"><a href="checkout.php">Checkout</a></li>
                <li class="hidden-xs"><a href="status.php">Status</a></li>
                <?php
...
<!-- Register section -->
 <section id="checkout">
   <div class="container" align="center">
     <div class="row">
       <div class="col-md-12" style="margin-left: 19%">
                      ...
                      <div class="panel-heading">
                        ...
                        <div class="panel-body">
                         <div class="row">
                            ...
                            <div class="col-md-2">
                              <div class="aa-checkout-single-bill">
                                <input type="text" name="l_name" placeholder="M.I*" required>
                              </div>
                            </div>
                          </div> 
                          <div class="row">
                          ...
                          <div class="row">
                          	<div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                 <input type="tel" name="contact"  placeholder="Contact No.*" maxlength="11" required>
                             </div>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <input type="text" name="country" placeholder="Barangay, Z.C.*" required>
                              </div>                             
                            </div>                           
                          </div>
                          <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="text" name="address" placeholder="7000*" required>                              
                              </div>                             
                            </div>
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="text" name="address" placeholder="Bldng. No. ex. 123* optional*">
                              </div>
                            </div>
                          </div>  
